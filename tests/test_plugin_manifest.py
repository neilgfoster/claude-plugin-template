...
Guards the install path: `/plugin marketplace add neilgfoster/<repo>` then
`/plugin install <name>@<repo>` only works if the root .claude-plugin/marketplace.json lists a
plugin whose `source` directory carries a valid .claude-plugin/plugin.json.
"""
